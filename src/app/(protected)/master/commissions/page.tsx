    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800 shadow rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Comissões */}
          <div 
            className="bg-gray-700 border border-gray-600 rounded-lg p-6 hover:border-green-500 hover:bg-gray-600 transition-all cursor-pointer"
          ...
          {/* Cliques */}
          <div 
            className="bg-gray-700 border border-gray-600 rounded-lg p-6 hover:border-blue-500 hover:bg-gray-600 transition-all cursor-pointer"
